...
\end{equation*}
%
The proof shows that the final term obtained by \texttt{parsley-garnish} can be rewritten in the form \scala{op.map(flip) <*> p}.
Thus, the obtained \scala{postfix} parser is equivalent to the hand-written version using \scala{chain.left1}.
